...
# count_down_duration = int(input("What is the count down duration in seconds?"))
# while count_down_duration > 0:
#     print(f"Countdown: {count_down_duration}")
#     time.sleep(1)
#     count_down_duration -= 1
# print("新年快乐！")
...
# counter = 0
# while True:
#     luck_value = round(random.random(),3)
#     print(luck_value)
#     if luck_value >= 0.95:
#         break
#     time.sleep(1)
#     counter += 1
# print(f"a total of {counter} tries took place")
...
# while True:
#     beat = random.randint(1,9)
#     b1 = b2
#     b2 = b3
#     b3 = beat
#     print(f"after {b1}, {b2}, {b3}")
#     if b1 == 8 and b2 == 8 and b3 == 6:
#         break
#     num_beat += 1
#     time.sleep(0.1)
# print(f"no of tries = {num_beat}")
